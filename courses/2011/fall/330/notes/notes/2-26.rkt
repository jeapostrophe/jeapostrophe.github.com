...
(test (* 2 (let/cc myk (+ 2 (myk 8))))
      16)
(test (interp (parse '(* 2 (bindcc myk (+ 2 (myk 8))))))
      16)
(test (* 2 (let/cc myk (+ 2 8)))
      20)
(test (interp (parse '(* 2 (bindcc myk (+ 2 8)))))
      20)
