...
double areaOfRing ( double inner, double outer ) {
  return areaOfDisk(outer) - areaOfDisk(inner);
  //return M_PI * pow( outer, 2 ) - M_PI * pow( inner, 2 );
}
...
// attendance ( 5 ) = 120
// attendance ( 5.1 ) = 105
long attendance ( double tp ) {
  double differenceInPrice = 5 - tp;
  double numberOfSteps = (differenceInPrice / .1);
  long differenceInPeople = round(floor(numberOfSteps * 15));
...
double bestPrice ( double first, double second, double third ) {
  // ... first ... second ... third ...
...
const char * bestPriceS ( double first, double second, double third ) {
  // ... first ... second ... third ...
  // ... profit(first) ... profit(second) ... profit(third) ...
  // boolean is true or false
...
int main () {
  ...
  printf("The answer is: %d but should be %d\n", convert3(7,4,1), 147);
  printf("The answer is: %d but should be %d\n", convert3(7,40,1), 507);
  printf("The answer is: %f but should be close to %f\n", areaOfDisk(2), 12.686);
  printf("The answer is: %f but should be close to %f\n", areaOfDisk(4), 4*12.686);
  printf("The answer is: %f but should be close to %f\n", areaOfRing(2,4), 3*12.686);

  printf("The answer is: %ld but should be close to %d\n", attendance(4.9), 135);
  printf("The answer is: %ld but should be close to %d\n", attendance(5), 120);
  printf("The answer is: %ld but should be close to %d\n", attendance(5.1), 105);
  printf("The answer is: %f but should be close to %f\n", cost(4.9), 185.4);
  printf("The answer is: %f but should be close to %f\n", cost(5.0), 184.8);
  ...
  printf("The answer is: %s but should be close to %s\n", bestPriceS(4.9,5,5.1), "First");
  printf("The answer is: %s but should be close to %s\n", bestPriceS(5,4.9,5.1), "Second");
  printf("The answer is: %s but should be close to %s\n", bestPriceS(5,5.1,4.9), "Third");
}
