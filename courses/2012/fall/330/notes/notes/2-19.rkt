...
;; where <id> is any Racket symbol, except +, -, *, /, fun, if0, rec, newbox, openbox, setbox, seqn, and with
                                     ...
                                     (refun (x)
                                            (refun (y)
                                                   (seqn 
                                                    ...
                                                    (setvar x (xor x y))
                                                    ;; [x -> (xor a b)] [y -> b]
                                                    (seqn (setvar y (xor x y))
                                                          ;; [x -> (xor a b)] [y -> (xor (xor a b) b)]
                                                          ;; [x -> (xor a b)] [y -> a]
                                                          (setvar x (xor x y))
                                                          ;; [x -> (xor (xor a b) a)] [y -> a]
                                                          ;; [x -> b] [y -> a]
