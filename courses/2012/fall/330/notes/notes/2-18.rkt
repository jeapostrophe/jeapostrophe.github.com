  ...
  (type-case
   ...
   [openbox
    ...
    (local
     ...
     ;; make sure box-e really is a boxV
     (type-case
      AEV box-v
      [boxV
       ;; figure out which ptr is in it
       (ptr)
       ;; look up that ptr
...
;; linearity --- ids that are used exactly once
;; store passing style
...
;; mutation is inherently anti-parallel
