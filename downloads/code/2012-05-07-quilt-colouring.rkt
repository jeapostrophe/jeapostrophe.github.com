...
She's a [mathematician](http://icme.stanford.edu/index.php), so she
knows about the [Four color
theorem](https://en.wikipedia.org/wiki/Four_color_theorem). But she
...
graph. Naturally, [Graphviz](http://graphviz.org/) is a natural
...
You can see the dot file here: [dot file](/downloads/code/tmp/2012-05-07-quilt-colouring.graph.dot), but unfortunately the picture wasn't very helpful. You can see it here: [graph PNG](/downloads/code/tmp/2012-05-07-quilt-colouring.graph.png).
...
<a href="/downloads/code/tmp/2012-05-07-quilt-colouring.png"><img src="/downloads/code/tmp/2012-05-07-quilt-colouring.png" align="center" /></a>
